...
export type TranslationKey =
  ...
  | 'settings.enableCompletionSound.name'
  | 'settings.enableCompletionSound.desc'
  | 'settings.completionSoundVolume.name'
  | 'settings.completionSoundVolume.desc'
  | 'settings.enableUserPromptTemplate.name'
  | 'settings.enableUserPromptTemplate.desc'
  | 'settings.userPromptTemplate.name'
  | 'settings.userPromptTemplate.desc'
  | 'settings.enableDailyJournal.name'
  ...
  | 'settings.enableSessionStore.name'
  | 'settings.enableSessionStore.desc'
  | 'settings.sessionStoreRootDir.name'
  | 'settings.sessionStoreRootDir.desc'
